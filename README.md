...
If troubleshooting a machine you will need to disable quiet boot to see error messages. <br>Open a terminal and run <code>sudo quietboot-off</code> and reboot.
